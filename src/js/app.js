App = {
     ...
     displayZombie: function (id, name, dna, level, readyTime, winCount, lossCount) {
          ...
          // note, this is done using jQuery
     ...
     randomHex: function (dna) {
          // var temp = 34534542; // test
          var hexString = dna.toString(16).substring(0,3); // have to shorten this for some reason, otherwise colour won't display!
          return "#" + hexString;
      },

      invertHex: function (hexString) {
          // Invert a hex string:
          var hexInt = parseInt(hexString);
          return ((hexInt & 0x000000) | (~hexInt & 0xFFFFFF)).toString();
      },
};
